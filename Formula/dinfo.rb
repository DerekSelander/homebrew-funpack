...
class Dinfo < Formula
  desc "Query runtime information about a process"

  depends_on :macos

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/DerekSelander/homebrew-funpack/archive/refs/tags/0.0.16.tar.gz"
...
#  conflicts_with "ipsw-frida"
  ...
  test do
    system "arch -arm64 #{bin}/dinfo --version"
